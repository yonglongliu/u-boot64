...
typedef struct kpd_tag
{
    volatile u32    ctl;
    volatile u32    int_en;
    volatile u32    int_raw_status;
    volatile u32    int_mask_status;
    volatile u32    int_clr;
    volatile u32    reserved;    ///reserved
    volatile u32    polarity;
    volatile u32    debounce_cnt;
    volatile u32    long_key_cnt;
    volatile u32    sleep_cnt;
    volatile u32    clk_divide_cnt;
    volatile u32    key_status;
    volatile u32    sleep_status;
    volatile u32    debug_status_1;  //only for debug
    volatile u32    debug_status_2;  //only for debug
} kpd_s;
