/* the head file modifier:     g   2015-03-19 15:40:59*/
...
#define REG_AP_CLK_CORE_clk_gsp0_cfg			SCI_ADDR(REGS_AP_CLK_CORE_BASE, 0x28)/*clk_gsp_cfg*/
...
#define REG_AP_CLK_CORE_clk_gsp1_cfg			SCI_ADDR(REGS_AP_CLK_CORE_BASE, 0xa0)/*clk_gsp1_cfg*/
#define REG_AP_CLK_AP_AHB_CFG           REG_AP_CLK_CORE_clk_ap_ahb_cfg
#define REG_AP_CLK_AP_APB_CFG           REG_AP_CLK_CORE_clk_ap_apb_cfg
#define REG_AP_CLK_GSP_CFG              REG_AP_CLK_CORE_clk_gsp0_cfg
...
/* bits definitions for register REG_AP_CLK_CORE_clk_gsp0_cfg */
#define BITS_CLK_GSP0_SEL(_X_)					( (_X_) & (BIT(0)|BIT(1)) )
...
/* bits definitions for register REG_AP_CLK_CORE_clk_gsp1_cfg */
#define BITS_CLK_GSP1_SEL(_X_)					( (_X_) & (BIT(0)|BIT(1)) )
