...
#define BIT_MPLL0_SOFT_CNT_DONE					( BIT(0) )
...
#define BIT_AUTO_REG_SAVE_TRIG_SEL				( BIT(1) )
...
#define BIT_AON_REDUN_CFG_3					( BIT(3) )
#define BIT_AON_REDUN_CFG_2					( BIT(2) )
#define BIT_AON_REDUN_CFG_1					( BIT(1) )
#define BIT_AON_REDUN_CFG_0					( BIT(0) )
