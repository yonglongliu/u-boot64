...
#define REG_PMU_APB_PD_APCPU_TOP_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0000)/*PD_APCPU_TOP_CFG*/
#define REG_PMU_APB_PD_APCPU_C0_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0004)/*PD_APCPU_C0_CFG*/
#define REG_PMU_APB_PD_APCPU_C1_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0008)/*PD_APCPU_C1_CFG*/
#define REG_PMU_APB_PD_APCPU_C2_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x000C)/*PD_APCPU_C2_CFG*/
#define REG_PMU_APB_PD_APCPU_C3_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0010)/*PD_APCPU_C3_CFG*/
#define REG_PMU_APB_PD_CA7_TOP_CFG          REG_PMU_APB_PD_APCPU_TOP_CFG
#define REG_PMU_APB_PD_CA7_C0_CFG           REG_PMU_APB_PD_APCPU_C0_CFG
#define REG_PMU_APB_PD_CA7_C1_CFG           REG_PMU_APB_PD_APCPU_C1_CFG
#define REG_PMU_APB_PD_CA7_C2_CFG           REG_PMU_APB_PD_APCPU_C2_CFG
#define REG_PMU_APB_PD_CA7_C3_CFG           REG_PMU_APB_PD_APCPU_C3_CFG
...
#define REG_PMU_APB_APCPU_TOP_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x00E4)/*APCPU_TOP_CFG*/
#define REG_PMU_APB_APCPU_C0_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x00E8)/*APCPU_C0_CFG*/
#define REG_PMU_APB_APCPU_C1_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x00EC)/*APCPU_C1_CFG*/
#define REG_PMU_APB_APCPU_C2_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x00F0)/*APCPU_C2_CFG*/
#define REG_PMU_APB_APCPU_C3_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x00F4)/*APCPU_C3_CFG*/
#define REG_PMU_APB_CA7_TOP_CFG			REG_PMU_APB_APCPU_TOP_CFG
#define REG_PMU_APB_CA7_C0_CFG			REG_PMU_APB_APCPU_C0_CFG
#define REG_PMU_APB_CA7_C1_CFG			REG_PMU_APB_APCPU_C1_CFG
#define REG_PMU_APB_CA7_C2_CFG			REG_PMU_APB_APCPU_C2_CFG
#define REG_PMU_APB_CA7_C3_CFG			REG_PMU_APB_APCPU_C3_CFG
...
#define REG_PMU_APB_R26M_SEL_CFG			SCI_ADDR(REGS_PMU_APB_BASE, 0x0134)/*26M_SEL_CFG*/
...
#define REG_PMU_APB_WAKEUP_LOCK_EN			SCI_ADDR(REGS_PMU_APB_BASE, 0x01A0)/*WAKEUP_LOCK_EN*/
#define REG_PMU_APB_PD_APCPU_C0_SHUTDOWN_MARK_STATUS	SCI_ADDR(REGS_PMU_APB_BASE, 0x3000)/*PD_APCPU_C0_SHUTDOWN_MARK_STATUS*/
#define REG_PMU_APB_PD_APCPU_C1_SHUTDOWN_MARK_STATUS	SCI_ADDR(REGS_PMU_APB_BASE, 0x3004)/*PD_APCPU_C1_SHUTDOWN_MARK_STATUS*/
#define REG_PMU_APB_PD_APCPU_C2_SHUTDOWN_MARK_STATUS	SCI_ADDR(REGS_PMU_APB_BASE, 0x3008)/*PD_APCPU_C2_SHUTDOWN_MARK_STATUS*/
#define REG_PMU_APB_PD_APCPU_C3_SHUTDOWN_MARK_STATUS	SCI_ADDR(REGS_PMU_APB_BASE, 0x300C)/*PD_APCPU_C3_SHUTDOWN_MARK_STATUS*/
#define REG_PMU_APB_PD_APCPU_TOP_SHUTDOWN_MARK_STATUS	SCI_ADDR(REGS_PMU_APB_BASE, 0x3010)/*PD_APCPU_TOP_SHUTDOWN_MARK_STATUS*/
#define REG_PMU_APB_PD_CA7_C0_SHUTDOWN_MARK_STATUS	REG_PMU_APB_PD_APCPU_C0_SHUTDOWN_MARK_STATUS
#define REG_PMU_APB_PD_CA7_C1_SHUTDOWN_MARK_STATUS	REG_PMU_APB_PD_APCPU_C1_SHUTDOWN_MARK_STATUS
#define REG_PMU_APB_PD_CA7_C2_SHUTDOWN_MARK_STATUS	REG_PMU_APB_PD_APCPU_C2_SHUTDOWN_MARK_STATUS
#define REG_PMU_APB_PD_CA7_C3_SHUTDOWN_MARK_STATUS	REG_PMU_APB_PD_APCPU_C3_SHUTDOWN_MARK_STATUS
#define REG_PMU_APB_PD_CA7_TOP_SHUTDOWN_MARK_STATUS	REG_PMU_APB_PD_APCPU_TOP_SHUTDOWN_MARK_STATUS
...
/* bits definitions for register REG_PMU_APB_PD_APCPU_TOP_CFG */
#define BIT_PD_APCPU_TOP_DBG_SHUTDOWN_EN	( BIT(28) )
#define BIT_PD_APCPU_TOP_STOP_EN	( BIT(27) )
#define BIT_PD_APCPU_TOP_PWR_INT_EN	( BIT(26) )
#define BIT_PD_APCPU_TOP_FORCE_SHUTDOWN	( BIT(25) )
#define BIT_PD_APCPU_TOP_AUTO_SHUTDOWN_EN	( BIT(24) )
#define BITS_PD_APCPU_TOP_PWR_ON_DLY(_X_)	( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_PD_APCPU_TOP_PWR_ON_SEQ_DLY(_X_)	( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_APCPU_TOP_ISO_ON_DLY(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_PD_CA7_TOP_DBG_SHUTDOWN_EN	BIT_PD_APCPU_TOP_DBG_SHUTDOWN_EN
#define BIT_PD_CA7_TOP_STOP_EN			BIT_PD_APCPU_TOP_STOP_EN
#define BIT_PD_CA7_TOP_PWR_INT_EN		BIT_PD_APCPU_TOP_PWR_INT_EN
#define BIT_PD_CA7_TOP_FORCE_SHUTDOWN	BIT_PD_APCPU_TOP_FORCE_SHUTDOWN
#define BIT_PD_CA7_TOP_AUTO_SHUTDOWN_EN	BIT_PD_APCPU_TOP_AUTO_SHUTDOWN_EN
...
/* bits definitions for register REG_PMU_APB_PD_APCPU_C0_CFG */
#define BIT_PD_APCPU_C0_WFI_SHUTDOWN_EN	( BIT(29) )
#define BIT_PD_APCPU_C0_DBG_SHUTDOWN_EN	( BIT(28) )
#define BIT_PD_APCPU_C0_PWR_RST_CFG	( BIT(26) )
#define BIT_PD_APCPU_C0_FORCE_SHUTDOWN	( BIT(25) )
#define BIT_PD_APCPU_C0_AUTO_SHUTDOWN_EN	( BIT(24) )
#define BITS_PD_APCPU_C0_PWR_ON_DLY(_X_)	( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_PD_APCPU_C0_PWR_ON_SEQ_DLY(_X_)	( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_APCPU_C0_ISO_ON_DLY(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_PD_CA7_C0_WFI_SHUTDOWN_EN	BIT_PD_APCPU_C0_WFI_SHUTDOWN_EN
#define BIT_PD_CA7_C0_DBG_SHUTDOWN_EN	BIT_PD_APCPU_C0_DBG_SHUTDOWN_EN
#define BIT_PD_CA7_C0_PWR_RST_CFG		BIT_PD_APCPU_C0_PWR_RST_CFG
#define BIT_PD_CA7_C0_FORCE_SHUTDOWN	BIT_PD_APCPU_C0_FORCE_SHUTDOWN
#define BIT_PD_CA7_C0_AUTO_SHUTDOWN_EN	BIT_PD_APCPU_C0_AUTO_SHUTDOWN_EN
...
/* bits definitions for register REG_PMU_APB_PD_APCPU_C1_CFG */
#define BIT_PD_APCPU_C1_WFI_SHUTDOWN_EN	( BIT(29) )
#define BIT_PD_APCPU_C1_DBG_SHUTDOWN_EN	( BIT(28) )
#define BIT_PD_APCPU_C1_PWR_RST_CFG	( BIT(26) )
#define BIT_PD_APCPU_C1_FORCE_SHUTDOWN	( BIT(25) )
#define BIT_PD_APCPU_C1_AUTO_SHUTDOWN_EN	( BIT(24) )
#define BITS_PD_APCPU_C1_PWR_ON_DLY(_X_)	( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_PD_APCPU_C1_PWR_ON_SEQ_DLY(_X_)	( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_APCPU_C1_ISO_ON_DLY(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_PD_CA7_C1_WFI_SHUTDOWN_EN	BIT_PD_APCPU_C1_WFI_SHUTDOWN_EN
#define BIT_PD_CA7_C1_DBG_SHUTDOWN_EN	BIT_PD_APCPU_C1_DBG_SHUTDOWN_EN
#define BIT_PD_CA7_C1_PWR_RST_CFG	BIT_PD_APCPU_C1_PWR_RST_CFG
#define BIT_PD_CA7_C1_FORCE_SHUTDOWN	BIT_PD_APCPU_C1_FORCE_SHUTDOWN
#define BIT_PD_CA7_C1_AUTO_SHUTDOWN_EN	BIT_PD_APCPU_C1_AUTO_SHUTDOWN_EN
...
/* bits definitions for register REG_PMU_APB_PD_APCPU_C2_CFG */
#define BIT_PD_APCPU_C2_WFI_SHUTDOWN_EN	( BIT(29) )
#define BIT_PD_APCPU_C2_DBG_SHUTDOWN_EN	( BIT(28) )
#define BIT_PD_APCPU_C2_PWR_RST_CFG	( BIT(26) )
#define BIT_PD_APCPU_C2_FORCE_SHUTDOWN	( BIT(25) )
#define BIT_PD_APCPU_C2_AUTO_SHUTDOWN_EN	( BIT(24) )
#define BITS_PD_APCPU_C2_PWR_ON_DLY(_X_)	( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_PD_APCPU_C2_PWR_ON_SEQ_DLY(_X_)	( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_APCPU_C2_ISO_ON_DLY(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_PD_CA7_C2_WFI_SHUTDOWN_EN	BIT_PD_APCPU_C2_WFI_SHUTDOWN_EN
#define BIT_PD_CA7_C2_DBG_SHUTDOWN_EN	BIT_PD_APCPU_C2_DBG_SHUTDOWN_EN
#define BIT_PD_CA7_C2_PWR_RST_CFG	BIT_PD_APCPU_C2_PWR_RST_CFG
#define BIT_PD_CA7_C2_FORCE_SHUTDOWN	BIT_PD_APCPU_C2_FORCE_SHUTDOWN
#define BIT_PD_CA7_C2_AUTO_SHUTDOWN_EN	BIT_PD_APCPU_C2_AUTO_SHUTDOWN_EN
...
/* bits definitions for register REG_PMU_APB_PD_APCPU_C3_CFG */
#define BIT_PD_APCPU_C3_WFI_SHUTDOWN_EN	( BIT(29) )
#define BIT_PD_APCPU_C3_DBG_SHUTDOWN_EN	( BIT(28) )
#define BIT_PD_APCPU_C3_PWR_RST_CFG	( BIT(26) )
#define BIT_PD_APCPU_C3_FORCE_SHUTDOWN	( BIT(25) )
#define BIT_PD_APCPU_C3_AUTO_SHUTDOWN_EN	( BIT(24) )
#define BITS_PD_APCPU_C3_PWR_ON_DLY(_X_)	( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BITS_PD_APCPU_C3_PWR_ON_SEQ_DLY(_X_)	( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_APCPU_C3_ISO_ON_DLY(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_PD_CA7_C3_WFI_SHUTDOWN_EN	BIT_PD_APCPU_C3_WFI_SHUTDOWN_EN
#define BIT_PD_CA7_C3_DBG_SHUTDOWN_EN	BIT_PD_APCPU_C3_DBG_SHUTDOWN_EN
#define BIT_PD_CA7_C3_PWR_RST_CFG	BIT_PD_APCPU_C3_PWR_RST_CFG
#define BIT_PD_CA7_C3_FORCE_SHUTDOWN	BIT_PD_APCPU_C3_FORCE_SHUTDOWN
#define BIT_PD_CA7_C3_AUTO_SHUTDOWN_EN	BIT_PD_APCPU_C3_AUTO_SHUTDOWN_EN
...
#define BIT_MM_GPU_SOFT_RST		( BIT(4) )
...
#define BITS_PD_APCPU_C3_STATE(_X_)	( (_X_) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
#define BITS_PD_APCPU_C2_STATE(_X_)	( (_X_) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BITS_PD_APCPU_C1_STATE(_X_)	( (_X_) << 8 & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BITS_PD_APCPU_C0_STATE(_X_)	( (_X_) << 4 & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BITS_PD_APCPU_TOP_STATE(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
...
/* bits definitions for register REG_PMU_APB_APCPU_TOP_CFG */
#define BIT_APCPU_L2RSTDISABLE		( BIT(0) )

/* bits definitions for register REG_PMU_APB_APCPU_C0_CFG */
#define BIT_APCPU_VINITHI_C0		( BIT(0) )

/* bits definitions for register REG_PMU_APB_APCPU_C1_CFG */
#define BIT_APCPU_VINITHI_C1		( BIT(0) )

/* bits definitions for register REG_PMU_APB_APCPU_C2_CFG */
#define BIT_APCPU_VINITHI_C2		( BIT(0) )

/* bits definitions for register REG_PMU_APB_APCPU_C3_CFG */
#define BIT_APCPU_VINITHI_C3		( BIT(0) )
...
/* bits definitions for register REG_PMU_APB_R26M_SEL_CFG */
...
#define BIT_PD_APCPU_TOP_BISR_DONE	( BIT(4) )
#define BIT_PD_APCPU_C3_BISR_DONE	( BIT(3) )
#define BIT_PD_APCPU_C2_BISR_DONE	( BIT(2) )
#define BIT_PD_APCPU_C1_BISR_DONE	( BIT(1) )
#define BIT_PD_APCPU_C0_BISR_DONE	( BIT(0) )
...
#define BIT_PD_APCPU_TOP_BISR_BUSY	( BIT(4) )
#define BIT_PD_APCPU_C3_BISR_BUSY	( BIT(3) )
#define BIT_PD_APCPU_C2_BISR_BUSY	( BIT(2) )
#define BIT_PD_APCPU_C1_BISR_BUSY	( BIT(1) )
#define BIT_PD_APCPU_C0_BISR_BUSY	( BIT(0) )
...
#define BIT_PD_APCPU_TOP_BISR_FORCE_BYP	( BIT(4) )
#define BIT_PD_APCPU_C3_BISR_FORCE_BYP	( BIT(3) )
#define BIT_PD_APCPU_C2_BISR_FORCE_BYP	( BIT(2) )
#define BIT_PD_APCPU_C1_BISR_FORCE_BYP	( BIT(1) )
#define BIT_PD_APCPU_C0_BISR_FORCE_BYP	( BIT(0) )
...
#define BIT_PD_APCPU_TOP_BISR_FORCE_EN	( BIT(4) )
#define BIT_PD_APCPU_C3_BISR_FORCE_EN	( BIT(3) )
#define BIT_PD_APCPU_C2_BISR_FORCE_EN	( BIT(2) )
#define BIT_PD_APCPU_C1_BISR_FORCE_EN	( BIT(1) )
#define BIT_PD_APCPU_C0_BISR_FORCE_EN	( BIT(0) )
...
#define BIT_APCPU_C3_GIC_WAKEUP_EN	( BIT(11) )
#define BIT_APCPU_C2_GIC_WAKEUP_EN	( BIT(10) )
#define BIT_APCPU_C1_GIC_WAKEUP_EN	( BIT(9) )
#define BIT_APCPU_C0_GIC_WAKEUP_EN	( BIT(8) )
#define BIT_PMUCPU_C3_PU_LOCK		( BIT(3) )
#define BIT_PMUCPU_C2_PU_LOCK		( BIT(2) )
#define BIT_PMUCPU_C1_PU_LOCK		( BIT(1) )
#define BIT_PMUCPU_C0_PU_LOCK		( BIT(0) )
...
#define BIT_PD_APCPU_TOP_CMG_HOLD_EN	( BIT(4) )
#define BIT_PD_APCPU_C3_CMG_HOLD_EN	( BIT(3) )
#define BIT_PD_APCPU_C2_CMG_HOLD_EN	( BIT(2) )
#define BIT_PD_APCPU_C1_CMG_HOLD_EN	( BIT(1) )
#define BIT_PD_APCPU_C0_CMG_HOLD_EN	( BIT(0) )
...
#define BIT_PD_APCPU_TOP_WAKEUP_LOCK_EN	( BIT(4) )
#define BIT_PD_APCPU_C3_WAKEUP_LOCK_EN	( BIT(3) )
#define BIT_PD_APCPU_C2_WAKEUP_LOCK_EN	( BIT(2) )
#define BIT_PD_APCPU_C1_WAKEUP_LOCK_EN	( BIT(1) )
#define BIT_PD_APCPU_C0_WAKEUP_LOCK_EN	( BIT(0) )

/* bits definitions for register REG_PMU_APB_PD_APCPU_C0_SHUTDOWN_MARK_STATUS */
#define BITS_PD_APCPU_C0_SHUTDOWN_MARK(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_APCPU_C1_SHUTDOWN_MARK_STATUS */
#define BITS_PD_APCPU_C1_SHUTDOWN_MARK(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_APCPU_C2_SHUTDOWN_MARK_STATUS */
#define BITS_PD_APCPU_C2_SHUTDOWN_MARK(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_APCPU_C3_SHUTDOWN_MARK_STATUS */
#define BITS_PD_APCPU_C3_SHUTDOWN_MARK(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for register REG_PMU_APB_PD_APCPU_TOP_SHUTDOWN_MARK_STATUS */
#define BITS_PD_APCPU_TOP_SHUTDOWN_MARK(_X_)	( (_X_) & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
