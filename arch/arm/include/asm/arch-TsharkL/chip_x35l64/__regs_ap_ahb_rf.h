...
#define REG_AP_AHB_APCPU_QCHN_CTL			SCI_ADDR(REGS_AP_AHB_BASE, 0x303C)/*APCPU_QCHN_CTL*/
...
#define BIT_APEMC_AUTO_GATE_EN		( BIT(4) )
#define BIT_CPU_EMC_AUTO_GATE_EN	( BIT(3) )
...
/* bits definitions for register REG_AP_AHB_JMP_ADDR_APCPU_C0 */
#define BITS_JMP_ADDR_APCPU_C0(_X_)	(_X_)

/* bits definitions for register REG_AP_AHB_JMP_ADDR_APCPU_C1 */
#define BITS_JMP_ADDR_APCPU_C1(_X_)	(_X_)

/* bits definitions for register REG_AP_AHB_JMP_ADDR_APCPU_C2 */
#define BITS_JMP_ADDR_APCPU_C2(_X_)	(_X_)

/* bits definitions for register REG_AP_AHB_JMP_ADDR_APCPU_C3 */
#define BITS_JMP_ADDR_APCPU_C3(_X_)	(_X_)

/* bits definitions for register REG_AP_AHB_APCPU_C0_PU_LOCK */
#define BIT_APCPU_C0_PU_LOCK		( BIT(0) )

/* bits definitions for register REG_AP_AHB_APCPU_C1_PU_LOCK */
#define BIT_APCPU_C1_PU_LOCK		( BIT(0) )

/* bits definitions for register REG_AP_AHB_APCPU_C2_PU_LOCK */
#define BIT_APCPU_C2_PU_LOCK		( BIT(0) )

/* bits definitions for register REG_AP_AHB_APCPU_C3_PU_LOCK */
...
/* bits definitions for register REG_AP_AHB_APCPU_C0_AUTO_FORCE_SHUTDOWN_EN */
#define BIT_APCPU_C0_AUTO_FORCE_SHUTDOWN_EN	( BIT(0) )

/* bits definitions for register REG_AP_AHB_APCPU_C1_AUTO_FORCE_SHUTDOWN_EN */
#define BIT_APCPU_C1_AUTO_FORCE_SHUTDOWN_EN	(	 BIT(0) )

/* bits definitions for register REG_AP_AHB_APCPU_C2_AUTO_FORCE_SHUTDOWN_EN */
#define BIT_APCPU_C2_AUTO_FORCE_SHUTDOWN_EN	( BIT(0) )

/* bits definitions for register REG_AP_AHB_APCPU_C3_AUTO_FORCE_SHUTDOWN_EN */
