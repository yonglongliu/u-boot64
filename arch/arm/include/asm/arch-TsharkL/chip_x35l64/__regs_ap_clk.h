...
#define  REGS_AP_CLK_CORE

/* registers definitions for AP_CLK_CORE */
#define REG_AP_CLK_CORE_clk_ap_ahb_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x20)/*clk_ap_ahb_cfg*/
#define REG_AP_CLK_CORE_clk_ap_apb_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x24)/*clk_ap_apb_cfg*/
#define REG_AP_CLK_CORE_clk_gsp_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x28)/*clk_gsp_cfg*/
#define REG_AP_CLK_CORE_clk_dispc0_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x2c)/*clk_dispc0_cfg*/
#define REG_AP_CLK_CORE_clk_dispc0_dbi_cfg		SCI_ADDR(REGS_AP_CLK_BASE, 0x30)/*clk_dispc0_dbi_cfg*/
#define REG_AP_CLK_CORE_clk_dispc0_dpi_cfg		SCI_ADDR(REGS_AP_CLK_BASE, 0x34)/*clk_dispc0_dpi_cfg*/
#define REG_AP_CLK_CORE_clk_nandc_ecc_cfg		SCI_ADDR(REGS_AP_CLK_BASE, 0x38)/*clk_nandc_ecc_cfg*/
#define REG_AP_CLK_CORE_clk_sdio0_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x3c)/*clk_sdio0_cfg*/
#define REG_AP_CLK_CORE_clk_sdio1_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x40)/*clk_sdio1_cfg*/
#define REG_AP_CLK_CORE_clk_sdio2_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x44)/*clk_sdio2_cfg*/
#define REG_AP_CLK_CORE_clk_emmc_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x48)/*clk_emmc_cfg*/
#define REG_AP_CLK_CORE_clk_otg_ref_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x4c)/*clk_otg_ref_cfg*/
#define REG_AP_CLK_CORE_clk_hsic_ref_cfg		SCI_ADDR(REGS_AP_CLK_BASE, 0x50)/*clk_hsic_ref_cfg*/
#define REG_AP_CLK_CORE_clk_uart0_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x54)/*clk_uart0_cfg*/
#define REG_AP_CLK_CORE_clk_uart1_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x58)/*clk_uart1_cfg*/
#define REG_AP_CLK_CORE_clk_uart2_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x5c)/*clk_uart2_cfg*/
#define REG_AP_CLK_CORE_clk_uart3_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x60)/*clk_uart3_cfg*/
#define REG_AP_CLK_CORE_clk_uart4_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x64)/*clk_uart4_cfg*/
#define REG_AP_CLK_CORE_clk_i2c0_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x68)/*clk_i2c0_cfg*/
#define REG_AP_CLK_CORE_clk_i2c1_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x6c)/*clk_i2c1_cfg*/
#define REG_AP_CLK_CORE_clk_i2c2_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x70)/*clk_i2c2_cfg*/
#define REG_AP_CLK_CORE_clk_i2c3_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x74)/*clk_i2c3_cfg*/
#define REG_AP_CLK_CORE_clk_i2c4_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x78)/*clk_i2c4_cfg*/
#define REG_AP_CLK_CORE_clk_spi0_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x7c)/*clk_spi0_cfg*/
#define REG_AP_CLK_CORE_clk_spi1_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x80)/*clk_spi1_cfg*/
#define REG_AP_CLK_CORE_clk_spi2_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x84)/*clk_spi2_cfg*/
#define REG_AP_CLK_CORE_clk_iis0_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x88)/*clk_iis0_cfg*/
#define REG_AP_CLK_CORE_clk_iis1_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x8c)/*clk_iis1_cfg*/
#define REG_AP_CLK_CORE_clk_iis2_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x90)/*clk_iis2_cfg*/
#define REG_AP_CLK_CORE_clk_iis3_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x94)/*clk_iis3_cfg*/
#define REG_AP_CLK_CORE_clk_zipenc_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x98)/*clk_zipenc_cfg*/
#define REG_AP_CLK_CORE_clk_zipdec_cfg			SCI_ADDR(REGS_AP_CLK_BASE, 0x9c)/*clk_zipdec_cfg*/
