...
#define REG_AON_CLK_CORE_clk_avs_cfg			SCI_ADDR(REGS_AON_CLK_CORE_BASE, 0x4c)/*clk_avs_cfg*/
...
/* bits definitions for register REG_AON_CLK_CORE_clk_avs_cfg */
#define BITS_CLK_AVS_SEL(_X_)		( (_X_) & (BIT(0)|BIT(1)) )
