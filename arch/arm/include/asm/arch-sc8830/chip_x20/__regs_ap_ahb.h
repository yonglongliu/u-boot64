...
#define REG_AP_AHB_CA7_RST_SET				SCI_ADDR(REGS_AP_AHB_BASE, 0x0008)	/*CA7_RST_SET */
...
#define REG_AP_AHB_JMP_ADDR_CA7_C0			SCI_ADDR(REGS_AP_AHB_BASE, 0x0018)	/*JMP_ADDR_CA7_C0 */
#define REG_AP_AHB_JMP_ADDR_CA7_C1			SCI_ADDR(REGS_AP_AHB_BASE, 0x001C)	/*JMP_ADDR_CA7_C1 */
#define REG_AP_AHB_JMP_ADDR_CA7_C2			SCI_ADDR(REGS_AP_AHB_BASE, 0x0020)	/*JMP_ADDR_CA7_C2 */
#define REG_AP_AHB_JMP_ADDR_CA7_C3			SCI_ADDR(REGS_AP_AHB_BASE, 0x0024)	/*JMP_ADDR_CA7_C3 */
#define REG_AP_AHB_CA7_C0_PU_LOCK			SCI_ADDR(REGS_AP_AHB_BASE, 0x0028)	/*CA7_C0_PU_LOCK */
#define REG_AP_AHB_CA7_C1_PU_LOCK			SCI_ADDR(REGS_AP_AHB_BASE, 0x002C)	/*CA7_C1_PU_LOCK */
#define REG_AP_AHB_CA7_C2_PU_LOCK			SCI_ADDR(REGS_AP_AHB_BASE, 0x0030)	/*CA7_C2_PU_LOCK */
#define REG_AP_AHB_CA7_C3_PU_LOCK			SCI_ADDR(REGS_AP_AHB_BASE, 0x0034)	/*CA7_C3_PU_LOCK */
#define REG_AP_AHB_CA7_CKG_CFG				SCI_ADDR(REGS_AP_AHB_BASE, 0x3000)	/*CA7_CKG_CFG */
#define REG_AP_AHB_MCU_PAUSE				SCI_ADDR(REGS_AP_AHB_BASE, 0x3004)	/*MCU_PAUSE */
#define REG_AP_AHB_MISC_CKG_EN				SCI_ADDR(REGS_AP_AHB_BASE, 0x3008)	/*MISC_CKG_EN */
#define REG_AP_AHB_MISC_CFG				SCI_ADDR(REGS_AP_AHB_BASE, 0x300C)	/*MISC_CFG */
#define REG_AP_AHB_AP_MTX_S3_PRIO0			SCI_ADDR(REGS_AP_AHB_BASE, 0x3010)	/*AP_MTX_S3_PRIO0 */
#define REG_AP_AHB_AP_MTX_S3_PRIO1			SCI_ADDR(REGS_AP_AHB_BASE, 0x3014)	/*AP_MTX_S3_PRIO1 */
#define REG_AP_AHB_AP_MTX_S3_PRIO2			SCI_ADDR(REGS_AP_AHB_BASE, 0x3018)	/*AP_MTX_S3_PRIO2 */
#define REG_AP_AHB_AP_MTX_S2_PRIO0			SCI_ADDR(REGS_AP_AHB_BASE, 0x301C)	/*AP_MTX_S2_PRIO0 */
#define REG_AP_AHB_AP_MTX_S1_PRIO0			SCI_ADDR(REGS_AP_AHB_BASE, 0x3020)	/*AP_MTX_S1_PRIO0 */
#define REG_AP_AHB_AP_MTX_S0_PRIO0			SCI_ADDR(REGS_AP_AHB_BASE, 0x3024)	/*AP_MTX_S0_PRIO0 */
#define REG_AP_AHB_AP_MTX_S0_PRIO1			SCI_ADDR(REGS_AP_AHB_BASE, 0x3028)	/*AP_MTX_S0_PRIO1 */
#define REG_AP_AHB_AP_MTX_S0_PRIO2			SCI_ADDR(REGS_AP_AHB_BASE, 0x302C)	/*AP_MTX_S0_PRIO2 */
#define REG_AP_AHB_AP_MAIN_MTX_HPROT_CFG		SCI_ADDR(REGS_AP_AHB_BASE, 0x3030)	/*AP_MAIN_MTX_HPROT_CFG */
#define REG_AP_AHB_CA7_STANDBY_STATUS			SCI_ADDR(REGS_AP_AHB_BASE, 0x3034)	/*CA7_STANDBY_STATUS */
#define REG_AP_AHB_NANC_CLK_CFG				SCI_ADDR(REGS_AP_AHB_BASE, 0x3038)	/*NANDC_CLK_CFG */
#define REG_AP_AHB_LVDS_CFG				SCI_ADDR(REGS_AP_AHB_BASE, 0x303C)	/*LVDS_CFG */
#define REG_AP_AHB_LVDS_PLL_CFG0			SCI_ADDR(REGS_AP_AHB_BASE, 0x3040)	/*LVDS_PLL_CFG0 */
#define REG_AP_AHB_LVDS_PLL_CFG1			SCI_ADDR(REGS_AP_AHB_BASE, 0x3044)	/*LVDS_PLL_CFG1 */
#define REG_AP_AHB_CA7_C0_AUTO_FORCE_SHUTDOWN_EN	SCI_ADDR(REGS_AP_AHB_BASE, 0x3048)	/*CA7_C0_AUTO_FORCE_SHUTDOWN_EN */
#define REG_AP_AHB_CA7_C1_AUTO_FORCE_SHUTDOWN_EN	SCI_ADDR(REGS_AP_AHB_BASE, 0x304C)	/*CA7_C1_AUTO_FORCE_SHUTDOWN_EN */
#define REG_AP_AHB_CA7_C2_AUTO_FORCE_SHUTDOWN_EN	SCI_ADDR(REGS_AP_AHB_BASE, 0x3050)	/*CA7_C2_AUTO_FORCE_SHUTDOWN_EN */
#define REG_AP_AHB_CA7_C3_AUTO_FORCE_SHUTDOWN_EN	SCI_ADDR(REGS_AP_AHB_BASE, 0x3054)	/*CA7_C3_AUTO_FORCE_SHUTDOWN_EN */
#define REG_AP_AHB_AP_QOS_CFG				SCI_ADDR(REGS_AP_AHB_BASE, 0x3058)	/*AP_QOS_CFG */
