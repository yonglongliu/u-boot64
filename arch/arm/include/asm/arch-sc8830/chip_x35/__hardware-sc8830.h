...
#define SPRD_ANA_PWN_PHYS		(SPRD_MISC_PHYS + 0x8020)
#define SPRD_ANA_WDG_PHYS		(SPRD_MISC_PHYS + 0x8040)
#define SPRD_ANA_RTC_PHYS		(SPRD_MISC_PHYS + 0x8080)
#define SPRD_ANA_EIC_PHYS		(SPRD_MISC_PHYS + 0x8100)
#define SPRD_ANA_PIN_PHYS		(SPRD_MISC_PHYS + 0x8180)
#define ANA_EFS_BASE		        (SPRD_MISC_PHYS + 0x8200)
#define SPRD_ANA_THM_PHYS		(SPRD_MISC_PHYS + 0x8280)
#define SPRD_ANA_ADC_PHYS		(SPRD_MISC_PHYS + 0x8300)
#define SPRD_ANA_INT_PHYS		(SPRD_MISC_PHYS + 0x8380)
#define SPRD_ANA_BLT_PHYS		(SPRD_MISC_PHYS + 0x83C0)
#define SPRD_ANA_AUDIF_PHYS		(SPRD_MISC_PHYS + 0x8400)
#define SPRD_ANA_GPIO_PHYS		(SPRD_MISC_PHYS + 0x8480)
#define SPRD_ANA_FPU_PHYS		(SPRD_MISC_PHYS + 0x8500)
#define SPRD_ANA_AUDCFG_PHYS		(SPRD_MISC_PHYS + 0x8600)
#define SPRD_ANA_HDT_PHYS		(SPRD_MISC_PHYS + 0x8700)
