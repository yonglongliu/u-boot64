...
ANA_REG_SET(ANA_REG_GLB_KPLED_CTRL, 0xEB4); //set kyled 3.0v 

#if defined(CONFIG_ADIE_SC2723S) || defined(CONFIG_ADIE_SC2723)
	ANA_REG_SET(ANA_REG_GLB_LDO_DCDC_PD,
		//BIT_LDO_EMM_PD | /*use by 7720A efuse*/
		BIT_DCDC_TOPCLK6M_PD | /*no use for 7720A*/
		//BIT_DCDC_RF_PD | /*no use for 7720A*/
		//BIT_DCDC_GEN_PD |
		//BIT_DCDC_MEM_PD |
		//BIT_DCDC_ARM_PD |
		//BIT_DCDC_CORE_PD |
	...
	ANA_REG_SET(ANA_REG_GLB_LDO_PD_CTRL,
		//BIT_LDO_LPREF_PD_SW |
		BIT_DCDC_WPA_PD | /*no use for 7720A*/
		BIT_DCDC_CON_PD |  /*no use for 7720A*/
		BIT_LDO_WIFIPA_PD | /*no use for 7720A*/
		BIT_LDO_SDCORE_PD |
		BIT_LDO_USB_PD |
		BIT_LDO_CAMMOT_PD |
		BIT_LDO_CAMIO_PD |
	...
	ANA_REG_SET(ANA_REG_GLB_PWR_SLP_CTRL0,
		BIT_SLP_IO_EN |
		BIT_SLP_DCDCRF_PD_EN | /*no use for 7720A*/
		//BIT_SLP_DCDCCON_PD_EN | /*no use for 7720A*/
		//BIT_SLP_DCDCGEN_PD_EN |
		//BIT_SLP_DCDCWPA_PD_EN | /*no use for 7720A*/
		...
		//BIT_SLP_LDOWIFIPA_PD_EN | /*no use for 7720A*/
	...
	*************************************************/
	...
	//redefine cp2 config due to some board don't use cp2, but it set in common file chip_phy_x30g.c
	...
	CHIP_REG_SET(REG_AON_APB_WBT_BG_CTRL,
		BIT_WBT_LDO_FORCE_PD |
		0
	);
