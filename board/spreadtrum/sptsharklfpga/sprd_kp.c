...
void board_keypad_init(void)
{
    ...
    __raw_writel(__raw_readl(REG_AON_APB_APB_EB0) | BIT_KPD_EB, REG_AON_APB_APB_EB0);
    __raw_writel(__raw_readl(REG_AON_APB_APB_RTC_EB) | BIT_KPD_RTC_EB, REG_AON_APB_APB_RTC_EB);
    __raw_writel(__raw_readl(REG_AON_APB_APB_RST0) | BIT_KPD_SOFT_RST, REG_AON_APB_APB_RST0);
    udelay(2000);
    __raw_writel(__raw_readl(REG_AON_APB_APB_RST0) & (~BIT_KPD_SOFT_RST), REG_AON_APB_APB_RST0);
