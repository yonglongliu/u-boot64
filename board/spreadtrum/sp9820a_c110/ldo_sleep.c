...
void init_ldo_sleep_gr(void)
{
	...
	ANA_REG_SET(ANA_REG_GLB_PWR_SLP_CTRL0,
		...
		//BIT_SLP_LDOGEN0_PD_EN | /* control by emmc driver */
		//BIT_SLP_LDODCXO_PD_EN | /*32kless VDDDCXO not shutdown when sleep*/
	...
	ANA_REG_SET(ANA_REG_GLB_PWR_SLP_CTRL2,
		...
		//BIT_SLP_LDOGEN0_LP_EN | /* control by emmc driver */
		//BIT_SLP_LDODCXO_LP_EN | /*if 32kless,vdddcxo will not shutdown when sleep,but not slp_lp*/
	...
	*************************************************/
	...
	/* powerdown rpll because it didn't use in pikel */
	CHIP_REG_OR(REG_AON_APB_AON_APB_RSV, BIT(5) | BIT(6));
