...
void init_ldo_sleep_gr(void)
{
    ...
    /*add by fangming.fang@spreadtrum.com, vddsim2 value 3.0v, bit15~bit8:b4*/
    ANA_REG_SET(ANA_REG_GLB_LDO_V_CTRL5,
        BITS_LDO_SIM2_V(0xb4) | (ANA_REG_GET(ANA_REG_GLB_LDO_V_CTRL5) & 0xFFFF00FF)
    );
	...
	*************************************************/
	...
	CHIP_REG_SET(REG_PMU_APB_MPLL0_REL_CFG,
		//BIT_MPLL0_REF_SEL |
		//BIT_MPLL0_ARM7_SEL |
		//BIT_MPLL0_VCP1_SEL |
		//BIT_MPLL0_VCP0_SEL |
