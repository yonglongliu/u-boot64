...
#define CONFIG_LCD
#ifdef  CONFIG_LCD
#define CONFIG_HOP_FREQ_SCALING
...
// DJT Configruation begin
//
// config for lcd
//***********************
#define CONFIG_LCD_FWVGA   1

#define CONFIG_FB_LCD_JD9161_1_MIPI
//#define CONFIG_FB_LCD_ILI9806E_MIPI

//#define CONFIG_C177_YMT_LCD_ILI9806E_YKL_BOE5P0
#define CONFIG_C177_YMT_LCD_JD9161_IVO4P95_IPS


// config for TP and other
//***********************
//#define CONFIG_DJT_TPIO_VDD2P8
//#define CONFIG_CTP_GESTURE_SUPPORT

#define CONFIG_MMTUNER_MN8855x
#define CONFIG_POWER_UP_RECOVERY_DOWN_FACTORY 0
#define CONFIG_LONGPRESS_POWER_OFF 0
// config for other
//***********************
//#define CONFIG_USE_EXT_AUDIO_AMP
//#define CONFIG_CHARGER_AW3215
//#define AW3215_CHG_EN 133
//#define CONFIG_KEYBOARD_SC
#endif /* __CONFIG_H */
