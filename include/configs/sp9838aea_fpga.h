...
/* Link Definitions */
#define CONFIG_SYS_TEXT_BASE		0x9f700000	/*1G RAM in 0xbf700000, 512M RAM in 0x9f700000 */
...
#define LTE_FIXNV_SIZE 0x00044000 // 272K the max size is 512k
#define LTE_RUNNV_SIZE 0x00064000 // 400k the max size is 512k
