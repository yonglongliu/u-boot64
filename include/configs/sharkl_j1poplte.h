...
#define LTE_FIXNV_ADDR 0x8b9e0000
#define LTE_RUNNV_ADDR (LTE_FIXNV_ADDR + LTE_FIXNV_SIZE)
#define LTE_MODEM_SIZE 0x00bb0000   //0x8f0000
...
#define WL_WARM_ADDR 0X8df00000
 ...
 */
/* malloc() len */
#define CONFIG_SYS_MALLOC_LEN		(CONFIG_ENV_SIZE + 5 * 1024 * 1024)	/* 5 MiB */
/*
...
#define CONFIG_FB_LCD_HX8369B_MIPI_SHARKL_J1POPLTE
#define CONFIG_FB_LCD_HX8379C_MIPI_SHARKL_J1POPLTE
//#define CONFIG_FB_LCD_SD7798D_MIPI_SHARKL_J1POPLTE
...
#define REAL_SDRAM_SIZE 0x30000000	/*dump 768M */
...
#define LTE_CP_SDRAM_SIZE        0x04600000     /*70M*/
...
#define CALIBRATION_FLAG_CP1         0x8b9D0000
