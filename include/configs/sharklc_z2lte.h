...
#define LTE_FIXNV_SIZE 0x00090000 // 576K the max size is 512k
#define LTE_RUNNV_SIZE 0x000B4000 // 704k the max size is 512k
#define LTE_FIXNV_ADDR 0x8AA42000
#define LTE_RUNNV_ADDR (LTE_FIXNV_ADDR + LTE_FIXNV_SIZE)
#define LTE_MODEM_SIZE 0x00C00000
#define LTE_MODEM_ADDR 0x8AB88000
...
#define WL_WARM_ADDR 0x8D100000
...
#define CONFIG_BOOTARGS "mem=1.5G loglevel=1 console=ttyS1,115200n8 init=/init " MTDPARTS_DEFAULT
...
//#define CONFIG_FB_LCD_HX8369B_MIPI_SHARKLS_J3LTE
//#define CONFIG_FB_LCD_HX8379C_MIPI_SHARKLS_J3LTE
//#define CONFIG_FB_LCD_SD7798D_MIPI_SHARKLS_J3LTE
#define CONFIG_FB_LCD_HX8369B_MIPI_SHARKLC_Z2LTE
#define CONFIG_FB_LCD_S6E8AA5X01_MIPI
...
#define REAL_SDRAM_SIZE 0x60000000	/*dump 768M */
...
#define LTE_CP_SDRAM_SIZE       0x04280000     /*66.5M*/
