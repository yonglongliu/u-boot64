...
extern struct panel_spec lcd_jd9161_1_mipi_spec;
...
extern struct panel_spec lcd_st7789v_spi_spec;
extern struct panel_spec lcd_gc9305_1_spi_spec;
...
#if defined (CONFIG_FB_LCD_GC9304_SPI)
		{
			.lcd_id = 0x9304,
...
#if defined (CONFIG_FB_LCD_GC9305_SPI)
		{
			.lcd_id = 0x9305,
...
#if defined (CONFIG_FB_LCD_GC9305_1_SPI)
                {
                        .lcd_id = 0x93051,
                        .panel = &lcd_gc9305_1_spi_spec,
                },
#endif

#if defined (CONFIG_FB_LCD_ST7789V_SPI)
                {
                        .lcd_id = 0x7789,
...
#if defined (CONFIG_FB_LCD_SC7798D_MIPI_PIKEBJ1MINI)
		{
			.lcd_id = 0x7798,
			.panel = &lcd_sc7798d_mipi_spec,
		},
#endif
#if defined (CONFIG_FB_LCD_S6D77ALA_MIPI_PIKEBJ1MINI)
		{
			.lcd_id = 0x77a108,
...
#ifdef CONFIG_FB_LCD_JD9161_1_MIPI
        {
                .lcd_id = 0x916111,
                .panel = &lcd_jd9161_1_mipi_spec,
        },
#endif
