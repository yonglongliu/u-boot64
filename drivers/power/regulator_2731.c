...
#include "__sc2731_regulator_map.h"
...
int DCDC_Cal_ArmCore(void)
{
	...
	printf("%s; adie chipid:(0x%08x), mixed_ctl:(0x%08x), otp_sel:(0x%08x), VBAT(vol %d, adc %d)\n",
		__func__, chip_id, ana_mixed_ctl, otp_pwr_sel, vbat_vol, vbat_adc);
