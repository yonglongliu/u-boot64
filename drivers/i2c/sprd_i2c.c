...
struct i2c_base_addr i2c_apb_bit[I2C_MAX_NUM] = {
	BIT_I2C0_EB,	SPRD_I2C0_BASE, AP_I2C,
	BIT_I2C1_EB,	SPRD_I2C1_BASE, AP_I2C,
	BIT_I2C2_EB,	SPRD_I2C2_BASE, AP_I2C,
	BIT_I2C3_EB,	SPRD_I2C3_BASE, AP_I2C,
	BIT_I2C4_EB,	SPRD_I2C4_BASE, AP_I2C,
...
static int sprd_set_bus_speed(struct i2c_adapter *adap, int speed)
{
	...
	writel((((i2c_div+2) & 0xffff)<<16|((i2c_div-2) & 0xffff)),
						i2c_base + I2C_CLKD0);
	writel(0X10, i2c_base + I2C_STA_STO_DVD);
	writel(((i2c_div+2) >> 16|((i2c_div-2)& 0xffff0000)),
						i2c_base + I2C_CLKD1);
