...
#BOOTLOADER_LOG is used for skipping save bootloader log for user.
ifneq ($(TARGET_BUILD_VARIANT),user)
CPPFLAGS += -DBOOTLOADER_LOG
endif
...
# SP9832 TEE requires VMM support
ifeq ($(strip $(CONFIG_WITH_VMM)),y)
CPPFLAGS += -DCONFIG_WITH_VMM
endif
