...
int fs_read_sandbox(const char *filename, void *buf, int offset, unsigned long len)
{
	int len_read;
...
int fs_write_sandbox(const char *filename, void *buf, int offset, unsigned long len)
{
	int len_written;
