...
LIBS-$(CONFIG_LCD) += drivers/video/sprdfb/ \
		drivers/video/sprdfb/lcd/ \
		drivers/video/sprdfb/dsi_1_10a/ \
		drivers/video/sprdfb/dsi_1_21a/
LIBS-y += drivers/spi/
...
# Add DX lib
PLATFORM_LIBDX = -L$(TOPDIR)/lib/secureboot/sansa/lib -ldx_sbrom
else
PLATFORM_LIBDX = 
endif
